...
# * Create a new data class named `Record`. T-43ehis class will serve as the
...
# YOUR CODE HERE 
sender_data = str(st.text_area("Enter Sender Address")).encode()

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver_data = str(st.text_area("Enter reciever Address")).encode()

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount_data = str(st.text_area("Enter Amount to send")).encode()
